                ...
                <td className={styles.actionCell}>
                  ...
                  {openMenuId === b.ticketID && (
                    <div className={styles.dropdown} onClick={(e) => e.stopPropagation()}>
                      ...
                      <li className={styles.dropdownItem} onClick={() => openModal(<DeactivateListings id={b.ticketID} />)}>Deactivate listing</li>
                      <li className={styles.dropdownItem} style={{color:"#E50909"}} onClick={() => openModal(<TicketDelete id={b.ticketID} />)} >Delete listing</li>
                    </div>
                  )}
                </td>   
              </tr>
