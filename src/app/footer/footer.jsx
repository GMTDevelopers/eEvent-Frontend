        ...
        <div className={styles.footer}>
            ...
            <div className={styles.footerSec2}>
                <div className={`${styles.footer2Txt} ${styles.section1}`}>
                    ...
                    <div className={`${styles.f2Pack2} ${styles.f2Pack22}`}>
                ...
                <div className={styles.copyRight}>
                    <p >Copyright © 2025 eEvents. All Rights Reserved. No part of this website, including text, design, or content, may be copied, reproduced, or used without written permission.</p>
                </div>
            </div>
        </div>
    );
