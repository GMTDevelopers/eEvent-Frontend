...
const Range = () => {
    ...
    const addServiceFeature = () => {
        setFeatures([...features, { from: "", to: "", price: "" }]);
    };
    ...
    return ( 
        <div>
            <div className={xStyles.addForm}>
                ...
                <div style={{background:"none", color:"#82027D"}} className={`btnNoCapsule ${styles.addServiceBtn}`} onClick={addServiceFeature}> <Plus />  Add Range </div>
            </div>
        </div>
    );
}
